Feature: code-break submits guess

  The code-break submits a guess of four numbers.  The game marks the guess with + and - signs.

  For each number in the guess that matches the number and position of a number in the secrete code, 
  the mark includes one + sign. For each number in the guess that matches the number but not in the 
